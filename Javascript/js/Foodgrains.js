...
//for only Foodgrains purpose
j=0;
 for(var i=0;i<particulars.length;i++)
 {
    if(particulars[i].includes("Agricultural Production Foodgrains"))
    {
...
for(var k=0;k<particulars1.length;k++)
{
 ...
 fs.writeFileSync("../json/Foodgraincrop.json",JSON.stringify(output),encoding="utf8");
